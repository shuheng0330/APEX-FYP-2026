...
import { CareerPathway, CareerPathwayAssignmentOverview, UpdateCareerPathwayAssignmentRequest } from '../../../../models/careerPathway.model';
...
@Component({
  selector: 'app-edit-career-pathway-assignment',
  ...
  templateUrl: './edit-career-pathway-assignment.component.html',
  styleUrl: './edit-career-pathway-assignment.component.scss'
})
export class EditCareerPathwayAssignmentComponent {
  @Output() formSubmitted = new EventEmitter<void>();

  private readonly confirmTitleKey = "PAGE.CAREER_PATHWAY.ASSIGNMENT.EDIT.CONFIRM.TITLE";
  private readonly confirmContentKey = "PAGE.CAREER_PATHWAY.ASSIGNMENT.EDIT.CONFIRM.CONTENT";
  private readonly confirmOkKey = "PAGE.CAREER_PATHWAY.ASSIGNMENT.EDIT.CONFIRM.OK";
  ...
  selectedRecord?: CareerPathwayAssignmentOverview;
      ...
      forkJoin({
        ...
        next: ({ orgChart, careerPathway, staff }) => {
          ...
          if (this.selectedRecord) {
            const staffIds = this.selectedRecord.staffs.flatMap(staff => staff.id);

            this.onDepartmentChange(this.selectedRecord.orgChartId);
            this.validateForm.reset({
              department: this.selectedRecord.orgChartId,
              careerPathway: this.selectedRecord.careerPathwayId,
              staff: staffIds
            })

            this.validateForm.get('department')?.disable();
            this.validateForm.get('careerPathway')?.disable();
          }
  ...
  submit(): void {
    if (this.validateForm.valid) {
      ...
      this.careerPathwayAssignmentService.edit(requestBody).subscribe({
        next: () => {
