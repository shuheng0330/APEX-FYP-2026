...
@Component({
  selector: 'app-view-competency-assignment',
  imports: [CommonModule, NzButtonModule, NzDrawerModule, TranslateModule, NzIconModule, NzTagModule,
    NzEmptyModule, NzCardModule, NzToolTipModule
  ],
  templateUrl: './view-competency-assignment.component.html',
  styleUrl: './view-competency-assignment.component.scss'
})
export class ViewCompetencyAssignmentComponent {
  ...
  data?: CompetencyAssignmentOverviewData;
