...
@Component({
  selector: 'app-edit-self-declared-skill',
  ...
  templateUrl: './edit-self-declared-skill.component.html',
  styleUrl: './edit-self-declared-skill.component.scss'
})
export class EditSelfDeclaredSkillComponent {
  @Output() formSubmitted = new EventEmitter<void>();

  private readonly confirmTitleKey = "PAGE.PROFILE.SKILL.EDIT.CONFIRM.TITLE";
  private readonly confirmContentKey = "PAGE.PROFILE.SKILL.EDIT.CONFIRM.CONTENT";
  private readonly confirmOkKey = "PAGE.PROFILE.SKILL.EDIT.CONFIRM.OK";
  ...
  selectedData?: StaffSelfDeclaredSkill;
  ...
  initialize(data: StaffSelfDeclaredSkill): void {
    this.adjustDrawerWidth();
  ...
  submit(): void {
    if (this.validateForm.valid) {
      ...
      if (!this.selectedData?.id || !skill || !proficiency || !staffId) return;
      ...
      this.staffSkillService.update(requestBody).subscribe({
        next: () => {
